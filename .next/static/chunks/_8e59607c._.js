...
"[project]/contexts/LangContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LangContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    lang: 'pt',
    setLang: ()=>{},
    tr: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"]['pt']
});
function LangProvider(param) {
    let { children } = param;
    _s();
    const [lang, setLangState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('pt');
    const setLang = (l)=>{
        setLangState(l);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LangContext.Provider, {
        value: {
            lang,
            setLang,
            tr: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][lang]
        },
        children: children
    }, void 0, false, {
        fileName: "[project]/contexts/LangContext.tsx",
        lineNumber: 26,
        columnNumber: 5
    }, this);
}
_s(LangProvider, "jrze6xoU2Dpu1sd003WycU8TXDY=");
_c = LangProvider;
const useLang = ()=>{
    _s1();
...
//# sourceMappingURL=_8e59607c._.js.map